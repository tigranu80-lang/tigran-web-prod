...
export function UseCases() {
    ...
    const gridConfig = [
        "grid-rows-[2.5fr_1fr_1fr_1fr] lg:grid-cols-[2.5fr_1fr_1fr_1fr] lg:grid-rows-1",
        "grid-rows-[1fr_2.5fr_1fr_1fr] lg:grid-cols-[1fr_2.5fr_1fr_1fr] lg:grid-rows-1",
        "grid-rows-[1fr_1fr_2.5fr_1fr] lg:grid-cols-[1fr_1fr_2.5fr_1fr] lg:grid-rows-1",
        "grid-rows-[1fr_1fr_1fr_2.5fr] lg:grid-cols-[1fr_1fr_1fr_2.5fr] lg:grid-rows-1",
    ];
    ...
    return (
        <section className="relative py-24 bg-[#F5F5F0] border-b border-[#0A0A0A]/5">
            ...
            <div className="container mx-auto px-6 max-w-7xl">
                <motion.div
                    className={`grid w-full h-[800px] lg:h-[600px] gap-2 ${gridConfig[activeIndex]}`}
                    layout
                                ...
                                <div className="relative z-10 h-full p-6 md:p-10 flex flex-col justify-between">
                                    ...
                                    <div className="flex flex-col gap-4">
                                        <div className="flex justify-between items-start">
                                            <span className="font-mono text-xl md:text-2xl text-[#0A0A0A]">
                                                {item.id}
                                            </span>
                                        ...
                                        <h3 className="font-serif text-2xl md:text-3xl leading-tight mt-2 min-h-[1.2em] text-[#0A0A0A]">
                                            ...
                                            {showContent && (
                                                ...
                                                >
                                                    <div className="pt-8 space-y-8">
                                                        {/* Problem Block */}
                                                        <div className="relative pl-6 border-l-2 border-[#0A0A0A]/10">
                                                            <span className="absolute -left-[5px] -top-1 w-2 h-2 rounded-full bg-[#0A0A0A]/20"></span>
                                                            <h4 className="font-mono text-[10px] uppercase tracking-widest text-[#0A0A0A]/50 mb-2">
                                                                Problem
                                                            </h4>
                                                            <p className="font-sans text-base text-[#0A0A0A]/80 leading-relaxed max-w-sm h-[4em]">
                                                                {animState.problem}
                                                            </p>
                                                        </div>

                                                        {/* Solution Block */}
                                                        <div className="relative pl-6 border-l-2 border-[#0A0A0A]">
                                                            ...
                                                            <p className="font-sans text-base font-medium text-[#0A0A0A] leading-relaxed max-w-sm h-[4em]">
                                                                {animState.solution}
                                                            </p>
                                                        </div>

                                                        {/* Result Metric */}
                                                        <div className="pt-6 mt-6 border-t border-[#0A0A0A]/10 flex items-center gap-4">
                                                            <div className="w-10 h-10 flex items-center justify-center bg-[#0A0A0A] text-white shadow-[2px_2px_0px_0px_rgba(234,88,12,1)]">
                                                                <Zap size={18} strokeWidth={1.5} />
                                                            </div>
                                                            <div>
                                                                <h4 className="font-mono text-[10px] uppercase tracking-widest text-[#0A0A0A]/50 mb-0.5">
                                                                    Impact
                                                                </h4>
                                                                <p className="font-mono text-lg font-bold text-[#0A0A0A] tracking-tight min-w-[100px]">
                                                                    {animState.impact}
                                                                </p>
                                                            </div>
                                                        </div>
                                        ...
                                        <AnimatePresence mode="wait">
                                            {!isActive ? (
                                                ...
                                                <motion.button
                                                    ...
                                                    exit={{ opacity: 0, y: 10 }}
                                                    transition={contentTransition}
                                                    className="px-6 py-3 bg-white text-[#0A0A0A] border-2 border-[#0A0A0A] rounded-none font-mono text-xs uppercase tracking-widest shadow-[4px_4px_0px_0px_#0A0A0A] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_#0A0A0A] transition-all flex items-center gap-2"
                                                >
                                                    BOOK FREE CALL
                                                    <ArrowRight size={14} />
                                                </motion.button>
