...
export function GlobeSection() {
    return (
        <section className="relative pt-24 pb-24 bg-transparent border-t border-ink-950">
            {/* Technical Cut - Section Label (Strict Team.tsx Pattern) */}
            ...
            {/* Header Content */}
            <div className="container mx-auto px-6 max-w-7xl relative z-20 text-center mb-12 mt-12">
                ...
                <p className="mt-6 text-ink-600 text-lg font-light max-w-2xl mx-auto leading-relaxed">
                    Real-time infrastructure monitoring across all active regions.
                </p>
            </div>
            ...
            <div className="container mx-auto px-4 md:px-6 max-w-6xl relative z-10">
                <div className="bg-white border-2 border-ink-950 shadow-[8px_8px_0px_0px_#0A0A0A]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x-2 divide-ink-950 bg-white">
                        ...
                        {/* Stat Column 1 */}
                        <div className="group relative p-6 md:p-8 hover:bg-ink-50 transition-colors duration-200">
                            ...
                            <div className="flex justify-between items-start mb-4">
                                <span className="font-mono text-[10px] uppercase tracking-widest text-ink-400">/// INFRASTRUCTURE</span>
                                <span className="font-mono text-[10px] text-ink-300">FIG. 01</span>
                            </div>
                            <div className="font-serif text-4xl md:text-5xl font-medium text-ink-950 mb-2">12</div>
                            <div className="font-sans text-xs text-ink-600 leading-relaxed font-light">
                                Global nodes active. <br />Latency optimized sub-50ms.
                            </div>
                        </div>
                        ...
                        <div className="group relative p-6 md:p-8 hover:bg-ink-50 transition-colors duration-200">
                            <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-orange-600 opacity-0 group-hover:opacity-100 transition-opacity" />
                            <div className="flex justify-between items-start mb-4">
                                <span className="font-mono text-[10px] uppercase tracking-widest text-ink-400">/// AVAILABILITY</span>
                                <span className="font-mono text-[10px] text-ink-300">FIG. 02</span>
                            </div>
                            <div className="font-serif text-4xl md:text-5xl font-medium text-ink-950 mb-2">99.9%</div>
                            <div className="font-sans text-xs text-ink-600 leading-relaxed font-light">
                                Uptime guarantee. <br />Auto-failover redundancy.
                            </div>
                        </div>
                        ...
                        <div className="group relative p-6 md:p-8 hover:bg-ink-50 transition-colors duration-200">
                            <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-orange-600 opacity-0 group-hover:opacity-100 transition-opacity" />
                            <div className="flex justify-between items-start mb-4">
                                <span className="font-mono text-[10px] uppercase tracking-widest text-ink-400">/// COMPLIANCE</span>
                                <span className="font-mono text-[10px] text-ink-300">FIG. 03</span>
                            </div>
                            <div className="font-serif text-4xl md:text-5xl font-medium text-ink-950 mb-2">GDPR</div>
                            <div className="font-sans text-xs text-ink-600 leading-relaxed font-light">
                                Sovereign data. <br />Full regulatory compliance.
                            </div>
                        </div>
